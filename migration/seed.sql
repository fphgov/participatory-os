...
INSERT INTO `workflow_states` (`id`, `code`, `title`, `private_title`, `description`) VALUES (121, 'PROF_DONE', 'Szakmailag jóváhagyva', 'Szakmailag jóváhagyva', 'Az ötletet szakmailag jóváhagytuk, önállóan, vagy másokkal összevonva.');

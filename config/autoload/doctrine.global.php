...
return [
    'doctrine' => [
        ...
        'connection' => [
            'orm_default' => [
                'params' => [
                    'url'           => 'mysql://' . configParser(getenv('DB_USER')) . ':' . configParser(getenv('DB_PASSWORD')) . '@' . configParser(getenv('DB_HOSTNAME')) . ':' . (int)configParser(getenv('DB_PORT')) . '/' . configParser(getenv('DB_DATABASE')),
